...
# Paths
export POSTGRESQL_VOLUME_DIR="${POSTGRESQL_VOLUME_DIR:-/pacloud/postgresql}"
export POSTGRESQL_BASE_DIR="/opt/pacloud/postgresql"
...
export PATH="${POSTGRESQL_BIN_DIR}:${PACLOUD_ROOT_DIR}/common/bin:${PATH}"
...
export NSS_WRAPPER_LIB="/opt/pacloud/common/lib/libnss_wrapper.so"

# Paths (Replication Manager)
export PATH="/opt/pacloud/repmgr/bin:/opt/pacloud/common/bin:$PATH"
export REPMGR_BASE_DIR="/opt/pacloud/repmgr"
export REPMGR_CONF_DIR="$REPMGR_BASE_DIR/conf"
export REPMGR_VOLUME_DIR="/pacloud/repmgr"
